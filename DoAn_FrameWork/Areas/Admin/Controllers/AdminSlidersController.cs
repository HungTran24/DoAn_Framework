...
namespace DoAn_FrameWork.Areas.Admin.Controllers
{
    ...
    public class AdminSlidersController : Controller
    {
        ...
        public AdminSlidersController(TechnoShop_DBContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Sliders != null ? 
                          ...
                          Problem("Entity set 'TechnoShop_DBContext.Sliders'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("SliderId,SliderName,SliderDesc,SliderImg")] Slider slider)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("SliderId,SliderName,SliderDesc,SliderImg")] Slider slider)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'TechnoShop_DBContext.Sliders'  is null.");
            }
            var slider = await _context.Sliders.FindAsync(id);
            if (slider != null)
            {
