...
namespace DoAn_FrameWork.Services
{
    public class VnPayService : IVnPayService
    {
        ...
        public VnPaymentResponseModel PaymentExecute(IQueryCollection collect)
        {
            var vnpay = new VnPayLibrary();
            foreach (var (key, value) in collect)
            {
            ...
            var vnp_SecureHash = collect.FirstOrDefault(p=>p.Key == "vnp_SecureHash").Value;  
