...
{
    public partial class AdminDBContextor : IdentityDbContext<AppUser>
    {
        public AdminDBContextor()
        {
        }

        public AdminDBContextor(DbContextOptions<AdminDBContextor> options)
            : base(options)
        {
        }
